...
app.get('/team_stats', function(req,res){
  ...
  .then(data => {
    res.render('pages/team_stats',{
        my_title: "CUB Football Team Stats",
        result_1: data[0],
        result_2: data[1],
        result_3: data[2]
      })
...
app.get('/player_info/select_player', function(req, res) {
  ...
  var query2 = 'select year, major, passing_yards, rushing_yards, receiving_yards, img_src from football_players where football_players.id = ' + player_id + ';';
